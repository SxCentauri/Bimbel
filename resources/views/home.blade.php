    ...
    <nav class="fixed w-full z-50 top-0 bg-gray-900/95 backdrop-blur-md shadow-2xl border-b border-gray-800" id="mainNav">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex items-center space-x-8 text-sm font-semibold tracking-wide text-gray-300 font-heading">
                    ...
                    <a class="hover:text-[#ffc800] transition duration-300 relative group" href="#portfolio">
                        Program <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#ffc800] transition-all group-hover:w-full"></span>
                    </a>
                    <a class="hover:text-[#ffc800] transition duration-300 relative group" href="#about">
        ...
        <div id="mobile-menu" class="lg:hidden bg-gray-900 border-t border-gray-800">
            <ul class="px-6 py-6 space-y-4 font-bold text-white uppercase text-sm font-heading">
                <li><a class="block hover:text-brand" href="#services">Fasilitas</a></li>
                <li><a class="block hover:text-brand" href="#portfolio">Program</a></li>
                <li><a class="block hover:text-brand" href="#about">Tentang</a></li>
                <li><a class="block hover:text-brand" href="#contact">Kontak</a></li>
            </ul>
        </div>
    </nav>
            ...
            <div class="flex flex-col-reverse lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="#portfolio" class="px-8 py-4 bg-[#ffc800] text-black font-bold rounded-lg shadow-[0_0_20px_rgba(255,200,0,0.4)] hover:shadow-[0_0_30px_rgba(255,200,0,0.6)] hover:bg-white transition duration-300 transform hover:-translate-y-1">
                            Program Belajar
                        </a>
                        <a href="#about" class="px-8 py-4 border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-black transition duration-300 transform hover:-translate-y-1">
                            Tentang Kami
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2" data-aos="fade-left" data-aos-duration="1200">
                    <div class="relative group">
                        <div class="absolute -top-10 -right-10 w-64 h-64 bg-[#ffc800] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
                        <div class="absolute -bottom-10 -left-10 w-64 h-64 bg-white rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
                        
                        <img src="{{ asset('landing-page/assets/img/img3.png') }}" alt="Siswa Belajar" class="relative rounded-2xl shadow-2xl border-4 border-gray-800 w-full object-cover transform rotate-2 group-hover:rotate-0 transition duration-500">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="card-ref p-8 flex flex-col items-start h-full bg-white group" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 font-heading group-hover:text-[#ffc800] transition-colors">Ruang Belajar Nyaman</h3>
                    <p class="text-gray-600 text-sm leading-relaxed mb-4">
                        Full AC, Free WiFi kecepatan tinggi, dan Full Furnished. Suasana belajar diset senyaman mungkin agar siswa betah.
                    </p>
                    <a href="#" class="mt-auto text-[#ffc800] font-bold text-sm hover:underline flex items-center gap-1 group/link">
        ...
        <div class="container mx-auto px-4 relative z-10 py-12">
            <div class="text-center max-w-4xl mx-auto mb-16" data-aos="fade-down">
                ...
                <p class="text-gray-400 text-base md:text-lg leading-relaxed">
                    ONMAI didukung oleh pengajar profesional dari universitas ternama yang memiliki pengalaman dalam mendidik siswa sejak 2014, serta materi ajar komprehensif yang disesuaikan dengan kurikulum terbaru.
                </p>
            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="border border-gray-100 bg-white rounded-3xl p-8 relative hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600 mb-8 italic leading-relaxed">"Belajar di ONMAI seru banget, gurunya asik dan cara ngajarnya mudah dimengerti. Alhamdulillah lulus Kedokteran UNIB."</p>
                    <div class="flex items-center gap-4 border-t border-gray-100 pt-6">
                        <img class="w-14 h-14 rounded-full object-cover border-2 border-[#ffc800] p-1" src="{{ asset('landing-page/assets/img/team/3.png') }}" alt="Rehan">
                        <div>
                            <h5 class="font-bold text-gray-900 text-base">Rehan</h5>
                            <p class="text-xs font-bold text-[#ffc800] uppercase tracking-wide">Kedokteran UNIB</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-100 bg-white rounded-3xl p-8 relative hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-gray-600 mb-8 italic leading-relaxed">"Suasana belajarnya nyaman, fasilitas lengkap. Sangat membantu persiapan UTBK saya tahun ini."</p>
                    <div class="flex items-center gap-4 border-t border-gray-100 pt-6">
                        <img class="w-14 h-14 rounded-full object-cover border-2 border-[#ffc800] p-1" src="{{ asset('landing-page/assets/img/team/1.png') }}" alt="Mayang">
                        <div>
                            <h5 class="font-bold text-gray-900 text-base">Mayang</h5>
                            <p class="text-xs font-bold text-[#ffc800] uppercase tracking-wide">Hukum UNIB</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-100 bg-white rounded-3xl p-8 relative hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="flex items-center gap-4 border-t border-gray-100 pt-6">
                        <img class="w-14 h-14 rounded-full object-cover border-2 border-[#ffc800] p-1" src="{{ asset('landing-page/assets/img/team/2.png') }}" alt="Masyah">
                        <div>
                            <h5 class="font-bold text-gray-900 text-base">Masyah</h5>
                            <p class="text-xs font-bold text-[#ffc800] uppercase tracking-wide">Manajemen UNIB</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-gray-50 border-t border-gray-200 pt-20 pb-10 text-sm text-gray-600">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-base">
                        <li><a href="#" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Sekolah Dasar (SD)</a></li>
                        <li><a href="#" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Sekolah Menengah (SMP)</a></li>
                        <li><a href="#" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">SMA Reguler</a></li>
                        <li><a href="#" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Persiapan UTBK & PTN</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-base">
                        <li><a href="#about" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Tentang Kami</a></li>
                        <li><a href="#services" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Fasilitas</a></li>
                        <li><a href="#team" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Testimoni</a></li>
                        <li><a href="#" class="hover:text-[#ffc800] hover:translate-x-1 inline-block transition">Karir Pengajar</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-6">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <span class="text-base font-medium">admin@onmai.com</span>
                        </li>
                        <li class="flex items-center gap-3">
                             <i class="fab fa-whatsapp text-[#ffc800] text-lg"></i>
                            <span class="text-base font-medium">0822-8237-7168</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <a href="https://wa.me/6282282377168" target="_blank" class="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white w-14 h-14 rounded-full shadow-2xl hover:scale-110 transition duration-300 flex items-center justify-center group">
